...
const CONFIG = {
  uiPath: process.env.JARVIS_UI_PATH || path.join(process.env.HOME, 'JARVIS', 'skills', 'jarvis-ui', 'sci-fi', 'apps', 'JARVIS'),
  neurographPath: process.env.NEUROGRAPH_PATH || path.join(process.env.HOME, 'JARVIS', 'skills', 'jarvis-ui', 'sci-fi', 'apps', 'neuro-graph'),
