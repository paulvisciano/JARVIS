...
description: Search neurograph (nodes + synapses) for people, places, events, concepts. Graph-first before raw transcripts. Works with any neurograph (JARVIS, personal, custom).
metadata:
  openclaw:
    emoji: "🔍"
    requires:
