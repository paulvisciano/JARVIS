            ...
            async execute(_id, params, context) {
                ...
                try {
                    ...
                    if (useStreaming) {
                        ...
                        const duration = await streamAndPlay(text, profile_id, config.voiceboxUrl, auto_play, save_path);
                        return {
                            content: [
                                {
                                    type: "text",
 ...
 */
async function streamAndPlay(text, profileId, voiceboxUrl, autoPlay, savePath) {
    const timestamp = Date.now();
