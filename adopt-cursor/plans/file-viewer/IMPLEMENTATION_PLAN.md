# Neurograph File Viewer - Implementation Plan

**Created:** March 12, 2026, 16:59 GMT+7  
...
### Video
- Paul's video from previous day (location: TBD, check `~/RAW/archive/2026-03-11/`)
...
1. **Review this plan with Cursor** (Paul to schedule session)
